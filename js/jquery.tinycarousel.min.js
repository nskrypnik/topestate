...
;(function ($) 
{
    ...
    function Carousel(root, options)
    {
		...
		,   oInfo     = $('.slide_details', root)
		,   oInfoContainer = $('.slide_details article', root)
        ,   iPageSize = 0
        ,   iSteps    = 0
        ,   iCurrent  = 0
        ,   oTimer    = undefined
        ...
        function setEvents()
        {
            ...
            if(options.interval)
            {
				...
				oInfo.hover(oSelf.stop,oSelf.start);
            }
		...
		this.showContent = function (i) {
			content = $('article.page' + i).text();
			oInfoContainer.text(content);
		}
